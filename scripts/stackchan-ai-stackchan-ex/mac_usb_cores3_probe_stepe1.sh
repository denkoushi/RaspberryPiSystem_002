#!/usr/bin/env bash
# CoreS3 Step E1 — simple sprite only (no m5stack-avatar).
set -euo pipefail

PROBE_DIR="$(cd "$(dirname "$0")/cores3-probe-stepe1" && pwd)"
PIO_ENV="${STACKCHAN_PROBE_PIO_ENV:-m5stack-cores3-probe-stepe1}"
