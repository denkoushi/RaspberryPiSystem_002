...
TRANSIENT_ONESHOT_STABILIZATION_TIMEOUT_SECONDS = 30
TRANSIENT_ONESHOT_STABILIZATION_ATTEMPTS = (
    TRANSIENT_ONESHOT_STABILIZATION_TIMEOUT_SECONDS
    // TRANSIENT_ONESHOT_STABILIZATION_DELAY_SECONDS
) + 1
