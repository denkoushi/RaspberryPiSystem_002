...
ROUTE_STAGES: tuple[RouteStage, ...] = (
    ...
    RouteStage(
        ...
        "pi5",
        "mutation",
        ("maintenance_ack_authority_sha256", "prepare_local_terminal_candidate"),
        "terminal.sealed-local-candidate-authorities",
        "manifest-rollback",
    ...
    RouteStage(
        ...
        "terminal",
        "mutation",
        ("submit_local_terminal_candidate",),
        "terminal.single-digest-bound-stdin-transfer",
        "reconcile-before-rollback",
        "local-terminal-executor",
        "local-executor-faults",
    ),
    RouteStage(
        ...
        "terminal",
        "mutation",
        ("await_local_terminal_candidate", "reconcile_local_terminal_candidate"),
        "terminal.deterministic-systemd-unit-and-lock",
        "retain-maintenance-while-unit-unknown",
        "local-terminal-executor",
        "local-executor-faults",
    ),
    RouteStage(
    ...
    RouteStage(
        ...
        "terminal",
        "read",
        ("prove_local_terminal_ready",),
        "terminal.exact-candidate-verification-challenge",
        "manifest-rollback",
        "coordinator",
        "local-executor-faults",
    ),
    ...
    RouteStage(
        ...
        "terminal",
        "mutation",
        ("cleanup_local_terminal_candidate",),
        "terminal.quiesced-run-scoped-residue",
