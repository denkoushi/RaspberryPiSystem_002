...
**概要**: `feat/signage-schedules-admin-list` を **`main` にマージ**（GitHub PR マージ後、CI を確認）。本番は **Pi5 のみ**反映（`--limit raspberrypi5`）で足りる API/Web 変更。Detach Run ID 例: **`20260401-134910-13950`**。Phase12 は **PASS 39 / WARN 0 / FAIL 0**（2026-04-01 実測）。
