...
6. **要領書要約の実運用確認**: `KIOSK_DOCUMENT_SUMMARY_INFERENCE_ENABLED=true` の有効化後、OCR 完了文書 1 件で `useCase: document_summary` の推論ログと UI 表示を確認し、必要なら [KB-313](./docs/knowledge-base/KB-313-kiosk-documents.md) へ運用知見を追記する。
