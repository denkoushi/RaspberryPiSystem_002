...
- [x] (2025-11-25) **Phase 1: 429エラー・404エラーの根本原因特定と修正**（最優先・他の機能にも影響）**ナレッジベース**: [KB-001](#kb-001-429エラーレート制限エラーが発生する), [KB-002](#kb-002-404エラーが発生する)
...
- [ ] (2025-11-25) **Phase 2: 削除機能の修正**（独立・データベース制約の問題）**ナレッジベース**: [KB-004](#kb-004-削除機能が動作しない)
...
- [ ] (2025-11-25) **Phase 3: インポート機能の修正**（独立・データ整合性の問題）**ナレッジベース**: [KB-003](#kb-003-p2002エラーnfctaguidの重複が発生する)
