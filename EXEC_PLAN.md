...
- [ ] (2025-12-27) **4件の未実施実機検証**: 以下の機能は実装完了しているが、実機検証が未実施です。詳細な検証手順は [docs/guides/verification-checklist.md](./docs/guides/verification-checklist.md) を参照してください。
  - **デプロイプロセス改善機能**: 自動デプロイ前チェック、構造化ログ生成、エラーハンドリング強化を実装完了。実機検証未実施。詳細は [docs/guides/verification-checklist.md#4-デプロイプロセス改善機能の検証未実施](./docs/guides/verification-checklist.md#4-デプロイプロセス改善機能の検証未実施) / [docs/guides/deployment.md](./docs/guides/deployment.md) / [docs/guides/deployment-troubleshooting.md](./docs/guides/deployment-troubleshooting.md) を参照。
