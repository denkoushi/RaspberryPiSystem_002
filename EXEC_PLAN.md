...
2. **Phase3 有効化（任意）**: inventory で `location_scope_phase3_enabled: true` に変更して再デプロイし、Phase3新経路を有効化。挙動確認後に legacy 経路の段階廃止を検討
