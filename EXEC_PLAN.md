...
- [x] (2025-12-27) **デプロイプロセス改善機能の実機検証完了**: 自動デプロイ前チェック、構造化ログ生成、エラーハンドリング強化を実装完了。**✅ 実機検証成功**（2025-12-27）。全チェック項目が正常に動作し、デプロイが1回で成功。試行錯誤の詳細（ansible pingタイムアウト、Pi3メモリ不足、Pi5のGit状態問題など）を標準ドキュメントに記録済み。詳細は [docs/guides/verification-checklist.md#4-デプロイプロセス改善機能の検証](./docs/guides/verification-checklist.md#4-デプロイプロセス改善機能の検証) / [docs/guides/deployment.md](./docs/guides/deployment.md) / [docs/guides/deployment-troubleshooting.md](./docs/guides/deployment-troubleshooting.md) / [docs/knowledge-base/infrastructure.md#kb-098](./docs/knowledge-base/infrastructure.md#kb-098-ansible_ssh_common_argsのrequestttyforceによるansible-pingタイムアウト) を参照。
- [x] (2025-12-27) **ドキュメントブラッシュアップ完了**: 試行錯誤の詳細を標準ドキュメントに記録。Ansible関連ドキュメントと`.cursor/rules`を更新。KB-098（ansible pingタイムアウト）、KB-097（Pi3 systemctl mask）、KB-096（Pi3再起動の必要性）の詳細を記録。詳細は [docs/guides/deployment.md](./docs/guides/deployment.md) / [docs/guides/deployment-troubleshooting.md](./docs/guides/deployment-troubleshooting.md) / [docs/knowledge-base/infrastructure.md](./docs/knowledge-base/infrastructure.md) / [.cursor/rules/system-stability.mdc](./.cursor/rules/system-stability.mdc) を参照。
- [ ] (2025-12-27) **3件の未実施実機検証**: 以下の機能は実装完了しているが、実機検証が未実施です。詳細な検証手順は [docs/guides/verification-checklist.md](./docs/guides/verification-checklist.md) を参照してください。
  - **CSVバックアップ（バックアップ対象管理UI）**: 管理コンソールからバックアップ対象を管理する機能を実装完了。実機検証未実施。詳細は [docs/guides/backup-target-management-verification.md](./docs/guides/backup-target-management-verification.md) / [docs/requirements/backup-target-management-ui.md](./docs/requirements/backup-target-management-ui.md) を参照。
  - **サイネージUIブラッシュアップ**: サイネージモニタの表示領域最大化と既存仕様準拠のUI改善を実装完了。実機検証未実施。詳細は [docs/guides/verification-checklist.md#5-サイネージuiブラッシュアップの検証未実施](./docs/guides/verification-checklist.md#5-サイネージuiブラッシュアップの検証未実施) / [docs/modules/signage/signage-lite.md](./docs/modules/signage/signage-lite.md) を参照。
  - **Gmail添付ファイル連携機能**: PowerAutomateからGmailにCSVファイルを添付ファイルとして送信し、Pi5が自動的にGmailから添付ファイルを取得してインポートする機能を実装完了。実機検証未実施。詳細は [docs/guides/verification-checklist.md#6-gmail添付ファイル連携機能の検証未実施](./docs/guides/verification-checklist.md#6-gmail添付ファイル連携機能の検証未実施) / [docs/guides/gmail-attachment-integration.md](./docs/guides/gmail-attachment-integration.md) / [docs/guides/powerautomate-gmail-integration.md](./docs/guides/powerautomate-gmail-integration.md) を参照。
