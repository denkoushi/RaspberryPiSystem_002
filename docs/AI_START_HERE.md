...
- Active deploy release-identity redesign (offline implementation ready; live rollout blocked): `docs/knowledge-base/KB-401-deploy-release-identity-runtime-audit.md`, `docs/plans/deploy-release-identity-architecture-execplan.md`
