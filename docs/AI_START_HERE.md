...
- Phase B deploy speed evidence: `docs/plans/deploy-speed-phase-b-execplan.md`
- Active StoneBase sealed local Ansible executor: `docs/plans/stonebase-local-ansible-execplan.md`
