...
- **実機（自動）**: `./scripts/deploy/verify-phase12-real.sh` → **PASS 43 / WARN 0 / FAIL 0**（約 **113s**）
- **HTTP**: `/kiosk/mobile-placement/shelf-master` **200**（Pi5 Tailscale）
