...
最終更新: 2026-06-24（順位ボード `+人` 人工数表示回復・8H/10H 切替・Gantt 縦バー伸長 §6.6.31 デプロイ/実機確認反映）。**2026-06-05 追記**: 資源カード行強調レイアウト §6.6.30。**2026-06-01 追記**: 完了後フッタ工程チップ装飾再同期 §6.6.29。
...
**検証結果**: ☑ 成功（自動: 8H/10H focused tests） ☑ 成功（自動: `+人` ON で minute label 400→575、縦バー 480px→575px、行カード高さ維持） ☑ 成功（現場目視: `+人` ON で人工数反映・8H バー伸長回復、速度改善/行維持は維持） ☑ 成功（本番画面: FJV60/80 `021` で `+人` OFF labels `700/700/252/720/648/225分`・ruler 6220px、ON labels `900/1000/342/840/848/285分`・ruler 8307px、10H ruler 5116px） ☐ 失敗（エラー内容: _______________）
