...
- ✅ **アイコン追加**: 工具🔧、計測機器📏、吊具⚙️のアイコンを追加完了
- ✅ **フォントサイズ改善**: 最小フォントサイズ14px、主要テキスト18px以上
- ✅ **情報並び順の統一** (2025-12-18): 工具/計測機器/吊具で統一（名称、従業員名、日付+時刻、警告）
- ✅ **日付と時刻の横並び配置** (2025-12-18): 同じY座標で横並びに配置、情報密度を向上
- ✅ **計測機器の管理番号表示修正** (2025-12-18): 上段の管理番号を削除、右下のみに表示
...
- 2025-12-18: サイネージカードの情報並び順統一、日付と時刻の横並び配置、計測機器の管理番号表示修正
