...
Raspberry Pi 4に様々なデバイスを接続する際の統合パターンと拡張性について、[クライアントデバイス統合アーキテクチャ](./client-device-integration.md)を参照してください。

- **ブラウザAPIを使用するデバイス**: カメラ、マイク、位置情報など（HTTPS設定が必要）
- **専用エージェントを使用するデバイス**: NFCリーダー、バーコードリーダーなど
