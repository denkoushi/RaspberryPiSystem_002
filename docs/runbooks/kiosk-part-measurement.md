...
- 一覧は製番・機種名・品名を大きな白文字、製造order・資源日本語名・最終更新・進捗を一行の補助情報で表示する。省略値はhoverで全文を確認し、最終更新に秒は表示しない。
...
3. 操作ボタンが横並び、約30.8px高、14px文字で、必要時だけ折り返すことを確認する。長い製造order、品番、品名、状態でも表やページに横スクロールが出ず、ツールチップで全文を確認できること。
