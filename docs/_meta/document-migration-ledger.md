...
|-------------|-----------------|------------------|--------|--------------|-------------|
| `docs/INDEX.md` latest-update blocks | Date-stamped narrative updates and deployment summaries. | Existing linked KB / Plan / ADR / Runbook / API documents. For kiosk leaderboard current specification, use `docs/knowledge-base/KB-392-kiosk-leaderboard-spec-source-of-truth.md`. | split | PR6-PR236 thinned selected recent blocks. PR50-PR51 moved remaining onsite smoke validation for seiban list and note-modal registration from `docs/INDEX.md` into KB-297. Continue by domain. | partial_pr236 |
...
PR237 should continue `docs/INDEX.md` thinning for another domain, or create the
