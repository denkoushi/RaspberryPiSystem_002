...
PR8 should continue `docs/INDEX.md` thinning for older leaderboard performance
and ordering blocks, or create the standard deployment / validation runbook
targets before shortening those guides.
