...
PR9 should continue `docs/INDEX.md` thinning for remaining leaderboard cache
and older history blocks, or create the standard deployment / validation
runbook targets before shortening those guides.
