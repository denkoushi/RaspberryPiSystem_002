...
|-------------|-----------------|------------------|--------|--------------|-------------|
| `docs/INDEX.md` latest-update blocks | Date-stamped narrative updates and deployment summaries. | Existing linked KB / Plan / ADR / Runbook / API documents. For kiosk leaderboard current specification, use `docs/knowledge-base/KB-392-kiosk-leaderboard-spec-source-of-truth.md`. | split | PR6-PR11 thinned recent leaderboard entries. PR12-PR43 thinned Mobile Placement Zero2W, Phase12/NOPASSWD, Mishima CSV Gmail, P2002, FKOJUNST, PowerAutomate datetime, Mishima Grinding no-date, plannedEndDate, Zero2W setup/assignment, DGX Phase11/KPI/Phase9/Phase7/Phase6/UI redesign/Phase5/GPU contention/Phase4/Phase3/Control Targets/sparkHost/typography/Phase2/Phase1, leaderboard rank picker, leaderboard resource chips, and leaderboard footer resource chips blocks. Continue by domain. | partial_pr43 |
...
PR44 should continue `docs/INDEX.md` thinning for another domain, or create the
