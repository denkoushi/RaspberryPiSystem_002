...
The three deferred product slices were reintroduced as merged PRs #1013, #1014, and #1015 rather than cherry-picking the mixed draft. Draft PR #1003 remains open, untouched, and unmerged at head `0f19936a` for provenance only. The current acceptance blocker is limited to terminal checkout ownership and exact interrupted-run recovery; later terminals were not mutated after the StoneBase canary stopped.
