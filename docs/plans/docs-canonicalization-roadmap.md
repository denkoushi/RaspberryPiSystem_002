...
### PR350: Thin Pi4 Maintenance Screen Index Block

Status: implemented in PR350.

- Thin only the 2026-01-19 Pi4 deployment maintenance-screen latest-update
  block in `docs/INDEX.md`.
- Preserve reachability, but replace the deploy script maintenance flag,
  deploy-status endpoint, kiosk polling, auto-clear behavior, onsite
  validation, rebuild/cache note, and KB-183 addition with short links to
  KB-183 and the deployment guide.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR380: Thin Signage Layout Verification Index Block

Status: implemented in PR380.

- Thin only the 2026-01-07 signage layout verification and UI improvement
  latest-update block in `docs/INDEX.md`.
- Preserve reachability, but replace the SPLIT left-PDF/right-tools
  validation, dynamic title, title overlap fix, duplicate PDF title removal,
  priority behavior, Pi3 timer issue, and layout-pattern validation details
  with short links to KB-150, the verification results guide, and the signage
  module doc.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR392: Thin API Restart Loop Index Block

Status: implemented in PR392.

- Thin only the 2026-01-04 API container restart-loop latest-update block in
  `docs/INDEX.md`.
- Preserve reachability, but replace the empty-value validation, compose
  fallback, preprocess fix, and onsite validation details with a short link to
  KB-131.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR396: Thin API HTTPS Deploy Index Block

Status: implemented in PR396.

- Thin only the 2026-01-03 API endpoint HTTPS and deployment procedure
  latest-update block in `docs/INDEX.md`.
- Preserve reachability, but replace the API base URL change, client agent
  access path, port exposure note, deployment doc update, and security note
  with short links to KB-128 and the deployment guide.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR412: Thin Backup Target UI Index Block

Status: implemented in PR412.

- Thin only the 2025-12-18 backup target management UI latest-update block in
  `docs/INDEX.md`.
- Preserve reachability, but replace the admin backup tab, target add/edit/delete,
  enable/disable, manual run, script/config consistency, immediate config
  reflection, and test coverage details with short links to the backup target
  requirements, verification guide, backup and restore guide, and backup
  configuration guide.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR416: Thin Dropbox CSV Phase 3 Verification Index Block

Status: implemented in PR416.

- Thin only the 2025-12-17 Dropbox CSV import Phase 3 complete verification
  latest-update block in `docs/INDEX.md`.
- Preserve reachability, but replace the real-data end-to-end verification,
  error-handling tests, backup history recording, restore path handling, all
  checks passing, and production-readiness details with short links to the
  integration status and Phase 3 verification documents.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR420: Thin Dropbox CSV Phase 2 Implementation Index Block

Status: implemented in PR420.

- Thin only the 2025-12-15 Dropbox CSV import Phase 2 implementation
  latest-update block in `docs/INDEX.md`.
- Preserve reachability, but replace the schedule execution, CI integration,
  csv-import-scheduler/imports-schedule/import-alert tests, ImportHistoryService,
  Prisma migration, CsvImportHistory table, and history-recording details with
  short links to the integration status and CSV import history migration guide.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.

### PR421: Thin Dropbox CSV Phase 1 Implementation Index Block

Status: implemented in PR421.

- Thin only the 2025-12-15 Dropbox CSV import Phase 1 implementation
  latest-update block in `docs/INDEX.md`.
- Preserve reachability, but replace the Dropbox CSV download/import,
  path-traversal prevention, validation, logging, error handling, added tests,
  CI requirement, and branch-protection guide details with short links to the
  integration status and CI branch protection guide.
- Do not edit deployment guide, verification checklist, KB index, or
  `EXEC_PLAN.md` in this PR.
...
### PR429: Thin Measuring Instrument Tag Field Index Block

Status: implemented in PR429.

- Thin only the 2025-12-11 measuring instrument NFC/RFID tag field
  latest-update block in `docs/INDEX.md`.
- Preserve reachability, but replace the registration form, duplicate UID
  handling, and RFID tag management page details with a short link to the
  measuring instruments UI document.
