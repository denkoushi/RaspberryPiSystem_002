...
- [ ] Pass exact-head CI for the structural runtime-capture correction, then repeat standard print-plan, preflight, release, and physical acceptance.
