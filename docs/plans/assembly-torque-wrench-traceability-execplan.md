...
- [ ] Enforce and validate the new three-layer release gate: immutable candidate SQL in CI/local launch, the live Pi5 ledger before release-unit submission, and the existing in-release recheck.
