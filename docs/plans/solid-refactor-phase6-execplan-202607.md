...
- status: implementation complete and verified locally; commit/CI in progress (this line to be updated with hashes and CI results)
...
- [ ] Commit, push, CI green, docs updated.
