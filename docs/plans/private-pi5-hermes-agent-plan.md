...
**北極星（製品ビジョン）**: 将来は同一 Discord 入口から **AI執事**（メモ・リマインド・定時情報・簡易アプリ・HA/カメラ連携）として **バックグラウンドで tools を安全に使う**。**いまは執事機能の一括実装は行わず**、Phase D でセキュアな土台を優先する。詳細ロードマップ: [AI執事ビジョンとロードマップ](./private-pi5-hermes-butler-vision-and-roadmap.md)。
...
- **2026-05-25**: **Phase D3 本番完了** — tools file+web · blocklist 同期 · [KB D3](../knowledge-base/KB-private-pi5-hermes-phase-d3-production.md) · PR [#336](https://github.com/denkoushi/RaspberryPiSystem_002/pull/336)。
- **2026-05-25**: **製品方針** — 最終 UX は **Discord 執事**。**当面はセキュア構築を優先**し chat はツール無効のまま。執事ロードマップを [butler vision](./private-pi5-hermes-butler-vision-and-roadmap.md) に固定。
- **2026-06-05**: **`/task` 復旧** — (1) 承認 relay の Discord REST に **Bot User-Agent**（Cloudflare `1010` 回避）· (2) DGX blue 27B は **snapshot path + `gpu-memory-utilization 0.65` + `language_model_only`**（`/v1/models` 502 回避）。正本 [KB D5 §2026-06-05](../knowledge-base/KB-private-pi5-hermes-phase-d5-production.md#本番復旧--discord-task-二段障害2026-06-05)。
...
| `/task` 無応答・承認 1010・DGX 502 | [KB D5 §2026-06-05](./../knowledge-base/KB-private-pi5-hermes-phase-d5-production.md#本番復旧--discord-task-二段障害2026-06-05) · [KB blue 502](./../knowledge-base/KB-private-pi5-hermes-task-dgx-profile-restore.md#追記--blue-backend-起動失敗で-v1models-5022026-06-05) |
| `yes` → **Interrupting current task** | [KB D5 §yes 最終修正](./../knowledge-base/KB-private-pi5-hermes-phase-d5-production.md#本番復旧--承認-yes-が割り込みに吸われる2026-06-05-夜--discord-write-e2e-完結) · [Runbook §base.py hotfix](../runbooks/private-pi5-hermes-deploy.md#hermes-agent-本体-hotfix承認-yes-の割り込み回避2026-06-05) |
| `/task` deferred pattern 拒否 | [KB D5 §安全枠](./../knowledge-base/KB-private-pi5-hermes-phase-d5-production.md#task-安全枠の明文化2026-06-05--repo) · [`task-bridge.policy.yaml`](../../scripts/private-pi5-hermes/config/task-bridge.policy.yaml) |
| `/daily` 未登録・危険プロンプト | [KB daily pilot](./../knowledge-base/KB-private-pi5-hermes-daily-pilot.md) · [`daily-pilot.policy.yaml`](../../scripts/private-pi5-hermes/config/daily-pilot.policy.yaml) |
| Phase D0 本番 | [KB Phase D0 本番](./../knowledge-base/KB-private-pi5-hermes-phase-d0-production.md) |
| Phase D3 本番 | [KB Phase D3 本番](./../knowledge-base/KB-private-pi5-hermes-phase-d3-production.md) |
| AI執事ビジョン・D4以降 | [butler vision](./private-pi5-hermes-butler-vision-and-roadmap.md) |
