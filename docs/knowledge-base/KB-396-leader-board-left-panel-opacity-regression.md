...
本番デプロイ: 2026-07-07 に Run ID `20260707-101530-31384` で Pi5+Pi4×5+Pi3 へ反映済み（[deployment.md §キオスクUI修正3件](../guides/deployment.md#kiosk-ui-fixes-leaderboard-tolerance-assembly-2026-07-07)）。Pi キオスク実機での視認性確認は未実施。

## Open Items

- Pi キオスク実機で左ペイン背景の視認性を確認する（2026-07-07 本番デプロイ済み。残りは実機目視確認のみ）
