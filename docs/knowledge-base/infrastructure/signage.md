...
- **キオスクと見た目が違う（2026-05-21 以降）**: Pi5 **`api` ref** が **`bdc25afb` 以降（コンパクト＋未完）または `main` HEAD**か確認。**Pi4 デプロイは不要**（API のみ）。Pi3 は **Pi5 未更新**を疑う。**`deviceScopeKey`** はデータスコープのみ。
...
**解決状況**: ✅ **実装・本番デプロイ（Pi5 のみ・初回〜4×8〜readability〜キオスク整合〜コンパクト＋未完 2026-05-21）・Phase12 実機検証（PASS 43/0/0）記録済み**
