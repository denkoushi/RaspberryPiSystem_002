...
**本番デプロイ（2026-05-21・ブランチ `feat/signage-leader-order-cards-5x2-grid-10`）**: **5列×2段・最大/既定10**（API + 管理 Web）。**対象**: **`raspberrypi5` のみ**。**手順**: [deployment.md](../../guides/deployment.md#signage-leader-order-cards-5x2-grid-10-2026-05-21)。**代表**: **`0fa2d065`**。**CI**: **`26204469250` success**。**Detach**: `20260521-131417-25249`（**`ok=134` `changed=4` `failed=0`**）。**Phase12**: **43/0/0**（約 **28s**）。**`main` マージ**: （本セッション PR リンク追記）。
