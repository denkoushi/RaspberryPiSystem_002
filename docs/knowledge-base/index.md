...
| 管理コンソール 貸出レポート（HTML・Gmail 下書き・送信） | [KB-354-admin-loan-report-gmail-draft-deploy.md](./KB-354-admin-loan-report-gmail-draft-deploy.md) | 1件 | `/admin` 貸出レポート・`GET/POST /api/reports/loan-report/*`・`gmail.compose` + **`gmail.send`**・**送信は ADMIN のみ**・**2026-04-19 §D**: 本番衛生化（ingest テレメトリ除去・Vitest）・Pi5 Detach **`20260419-081737-4484`**・Phase12 42/1/0・**2026-04-18** Detach **`20260418-204637-27968`**（実メトリクス）/ **`20260418-183700-7508`**（送信）/ **`20260418-152952-9706`**（下書き）・**`git stash push -u`** |
