...
| DGXリソース Phase3–6 UI（補助起停・ポリシー自動調停・複合シナリオ／運用コンソール・目的別4操作／post-policy Comfy） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | Phase3–5 記録 **+ Phase6**（**`feat/dgx-resource-ui-task-first`**・**`5ac0f17d`**・Detach **`20260503-140320-20910`**・Phase12 **43/0/0**・post-policy / `targetId` / `tsconfig.build` 知見）**+ Phase5 UI**（**`feat/dgx-resource-ui-redesign`**・**`d449b655`**・Detach **`20260503-131606-21654`**・Phase12 **43/0/0**） |
...
| [KB-365](./KB-365-dgx-resource-phase3-workload-orchestration.md) | DGXリソース Phase3–6（Phase6 **`feat/dgx-resource-ui-task-first`・`5ac0f17d`・Detach `20260503-140320-20910`・KB §Phase6**／Phase5 UI **`d449b655`・Detach `20260503-131606-21654`**） | ✅ 記録（2026-05-03） |
