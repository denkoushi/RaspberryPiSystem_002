...
| キオスク部品測定記録 | [KB-320-kiosk-part-measurement.md](./KB-320-kiosk-part-measurement.md) | 1件 | `/kiosk/part-measurement`・`part-measurement` API・テンプレ管理 `/admin/tools/part-measurement-templates`・テンプレ未一致・候補複数・工程 `cutting`/`grinding`（[ADR-20260329](../decisions/ADR-20260329-part-measurement-kiosk-record.md)） |
