...
| 写真持出 VLM ラベル | [KB-319-photo-loan-vlm-tool-label.md](./KB-319-photo-loan-vlm-tool-label.md) | 1件 | VLM 初版 + **フェーズ1（2026-03-29）** + **類似候補ギャラリー（pgvector・2026-03-29 実機: Phase12 PASS 34/0/0・未認証 candidates 401）**: 人レビュー列/API/管理 UI、Vision 入力、`GET .../photo-similar-candidates`、`PHOTO_TOOL_EMBEDDING_*`・[ADR-20260330](../decisions/ADR-20260330-photo-tool-similarity-gallery-pgvector.md) |
