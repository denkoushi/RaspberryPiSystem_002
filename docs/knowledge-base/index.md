...
| キオスク持出一覧カードレイアウト | [KB-323-kiosk-return-card-button-layout.md](./KB-323-kiosk-return-card-button-layout.md) | 1件 | 返却・取消をカード**下段**へ・`KioskActiveLoanCard` 分離・画像モーダル Blob `revoke`・**2026-04-29 追補**: 貸出日時 `formatKioskActiveLoanBorrowedAt`（秒なし・Pi5 のみデプロイ実績）・検証・デプロイ参照（2026-04-01 起票） |
