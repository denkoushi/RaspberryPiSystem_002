...
| DGXリソース Phase3–9（補助起停〜複合シナリオ／運用コンソール／目的別4操作／post-policy・最小 UI・gateway／Strict Ready／Ansible） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | Phase3–7 に加え **Phase9**（**`feat/dgx-resource-ready-guarantee`**・**`8cbc6f38`**・Orchestration **Strict Ready**・タイムアウト **安全ロールバック**・`readiness*`） |
...
| [KB-365](./KB-365-dgx-resource-phase3-workload-orchestration.md) | DGXリソース Phase3–9（§Phase9 **`8cbc6f38`**・Strict Ready・ロールバック／§Phase7 **`956cccf7` / `0a136ce9`**／Phase6 **`5ac0f17d`**／Phase5 UI **`d449b655`**） | ✅ 記録（2026-05-03） |
