...
- 2026-04-29（DGX Spark private ComfyUI・コンテナ雛形）: [dgx-private-comfyui.md](../runbooks/dgx-private-comfyui.md)・[`scripts/dgx-private-comfyui/README.md`](../../scripts/dgx-private-comfyui/README.md)・[dgx-spark-local-llm-migration-execplan.md](../plans/dgx-spark-local-llm-migration-execplan.md) Progress・`docs/INDEX.md`・`EXEC_PLAN.md` Progress。**DGX 実機 `docker compose build/up` と Mac ブラウザ検証は運用者未実施**。
