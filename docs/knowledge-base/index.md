...
| キオスク「集計」: DADS・吊具/持出返却アイテム・`loan-analytics` | [KB-334-kiosk-rigging-loan-analytics-deploy.md](./KB-334-kiosk-rigging-loan-analytics-deploy.md) | 1件 | **`/api/tools/items/loan-analytics`**・Pi5 のみ可・2026-04-09 Detach **`20260409-213409-15007`**・Phase12 **43/0/0**；初回吊具は 2026-04-07 Pi5→Pi4×4・Chromium 初回 DL 知見 |
