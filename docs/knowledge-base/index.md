...
- 2026-04-24（購買照会バーコード即時確定・Web・Pi5 のみ）: [KB-339 §V26](./KB-339-mobile-placement-barcode-survey.md#v26-purchase-order-barcode-instant-2026-04-24)・[deployment.md](../guides/deployment.md) — **`fix/kiosk-purchase-order-barcode-instant`**・**`4bc2698f`**・**`raspberrypi5` のみ**・Detach **`20260424-102338-6782`**・**Phase12 PASS 43/0/0**（約 **96s**）。`KIOSK_STANDARD_BARCODE_SCAN_SESSION`・購買 **`stabilityConfig` 撤去**（配膳/パレットと同等の即時確定）。`EXEC_PLAN.md` Progress を整合。
