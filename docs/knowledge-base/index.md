...
- 2026-05-06（**CSV ダッシュボード Gmail**・三島研削 **`ProductionSchedule_Mishima_Grinding`**・NON_RETRIABLE 廃棄成功時は **`failedMessageIdSuffixes` から除外**・調査用 localhost 計測コード除去）: [KB-297 §空BOM・廃棄](./KB-297-kiosk-due-management-workflow.md#mishima-grinding-empty-csv-bom-nonretriable-2026-05-06)・[csv-import-export.md](../guides/csv-import-export.md)・[PR #259](https://github.com/denkoushi/RaspberryPiSystem_002/pull/259)。**実装**: [`csv-dashboard-import.service.ts`](../../apps/api/src/services/csv-dashboard/csv-dashboard-import.service.ts)·[`csv-dashboard-import.service.ingest-behavior.test.ts`](../../apps/api/src/services/csv-dashboard/__tests__/csv-dashboard-import.service.ingest-behavior.test.ts)。**本番**: **`main` マージ後** Pi5 API のみ [deployment.md](../guides/deployment.md) 標準。
