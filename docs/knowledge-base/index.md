...
| [KB-335](./infrastructure/signage.md#kb-335-キオスク順位ボード資源cdカードkiosk_leader_order_cardsサイネージ-jpeg) | キオスク順位ボード・資源CDカード（`kiosk_leader_order_cards`）JPEG・管理画面で資源CD複数指定 | ✅ 解決済み（2026-04-07・Pi5 のみデプロイ・Phase12 PASS 43/0/0） |
