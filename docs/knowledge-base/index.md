...
| DGXリソース Phase3（補助起停・ポリシー自動調停） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | **`experiment-lab` ターゲット**・`DGX_RESOURCE_*_RUNTIME_*`・**`SET_POLICY.applyWorkloadChanges`**・Ansible env 出力拡張（2026-05-03） |
