...
| 管理コンソール 貸出レポート（HTML・Gmail 下書き・送信） | [KB-354-admin-loan-report-gmail-draft-deploy.md](./KB-354-admin-loan-report-gmail-draft-deploy.md) | 1件 | `/admin` 貸出レポート・`GET/POST /api/reports/loan-report/*`・`gmail.compose` + **`gmail.send`**・**送信は ADMIN のみ**・**2026-04-18** Pi5 のみ Detach **`20260418-204637-27968`**（実メトリクス・プレビュー幅）/ **`20260418-183700-7508`**（送信レイアウト）/ **`20260418-152952-9706`**（下書き）・Phase12 42/1/0・**`git stash push -u`** |
