...
| [KB-258](./api.md#kb-258-コード品質改善フェーズ2ratchet-型安全化lint抑制削減契約型拡張) | コード品質改善フェーズ2（Ratchet）〜フェーズ4第三弾（残サービス層テスト拡張＋signage性能ゲート追加） | ✅ 解決済み |
