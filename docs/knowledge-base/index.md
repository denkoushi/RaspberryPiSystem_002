...
| 配膳スマホ V1/V2/V3（バーコード・照合・配置登録） | [KB-339-mobile-placement-barcode-survey.md](./KB-339-mobile-placement-barcode-survey.md) | 1件 | V3: `/kiosk/mobile-placement/shelf-register` 棚番3段階・V2: 移動票/現品票照合・`OrderPlacementEvent`・V1: `Item`・`MobilePlacementEvent`・[Runbook](../runbooks/mobile-placement-smartphone.md)・[API](../api/mobile-placement.md)（2026-04-11） |
