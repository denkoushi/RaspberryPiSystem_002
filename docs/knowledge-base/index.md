...
| DGXリソース Phase3/4（補助起停・ポリシー自動調停・複合シナリオ／運用ヒント） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | Phase3: **`experiment-lab` ターゲット**・`DGX_RESOURCE_*_RUNTIME_*`・**`SET_POLICY.applyWorkloadChanges`**・Ansible env 出力・**Pi5 本番**（Detach **`20260503-094340-23537`**）。Phase4: **`PREVIEW_ORCHESTRATION_SCENARIO` / `EXECUTE_ORCHESTRATION_SCENARIO`**・**`overview.monitoring`**・**Pi5 本番**（Detach **`20260503-102936-930`**）。Phase12 **43/0/0**（2026-05-03） |
...
| [KB-365](./KB-365-dgx-resource-phase3-workload-orchestration.md) | DGXリソース Phase3/4（Phase3: 補助起停・ワークロード自動調停／Phase4: 複合シナリオ・`overview.monitoring`・実機反映） | ✅ 記録（2026-05-03） |
