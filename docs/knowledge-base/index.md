...
| [KB-305](./frontend.md#kb-305-生産スケジュール-製造order番号ポップアップ検索5桁候補部品選択チェック確定) | 生産スケジュール 製造order番号ポップアップ検索（5桁候補・部品選択・チェック確定） | ✅ 実装完了（2026-03-17） |
