...
| DGXリソース Phase3/4/5 UI（補助起停・ポリシー自動調停・複合シナリオ／運用ヒント／運用コンソール Web 再設計） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | Phase3–5 API 記録に加え **Phase5 UI**（**`feat/dgx-resource-ui-redesign`**・**`d449b655`**・Detach **`20260503-131606-21654`**・Phase12 **43/0/0**）を追記 |
...
| [KB-365](./KB-365-dgx-resource-phase3-workload-orchestration.md) | DGXリソース Phase3/4/5（Phase5 UI 再設計 Web のみ・`d449b655`・Detach `20260503-131606-21654` 含む） | ✅ 記録（2026-05-03） |
