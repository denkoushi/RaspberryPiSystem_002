...
| [KB-258](./api.md#kb-258-コード品質改善フェーズ2ratchet-型安全化lint抑制削減契約型拡張) | コード品質改善フェーズ2（Ratchet）: 型安全化・Lint抑制削減・契約型拡張 | ✅ 解決済み |
