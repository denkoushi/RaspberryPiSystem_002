...
| 配膳スマホ V1（バーコード・配置登録） | [KB-339-mobile-placement-barcode-survey.md](./KB-339-mobile-placement-barcode-survey.md) | 1件 | 現場バーコード採取ゲート・`Item.itemCode` 解決・`MobilePlacementEvent` 履歴・`/api/mobile-placement/*`・[Runbook](../runbooks/mobile-placement-smartphone.md)・[API](../api/mobile-placement.md)（2026-04-10） |
