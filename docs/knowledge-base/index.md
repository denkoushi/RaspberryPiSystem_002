...
| DGXリソース Phase3（補助起停・ポリシー自動調停） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | **`experiment-lab` ターゲット**・`DGX_RESOURCE_*_RUNTIME_*`・**`SET_POLICY.applyWorkloadChanges`**・Ansible env 出力・**Pi5 本番デプロイ**（Detach **`20260503-094340-23537`**）・Phase12 **43/0/0**（2026-05-03） |
...
| [KB-365](./KB-365-dgx-resource-phase3-workload-orchestration.md) | DGXリソース Phase3・補助起停・ワークロード自動調停（`experiment-lab`・`applyWorkloadChanges`） | ✅ 記録（2026-05-03） |
