...
| DGXリソース Phase3–7（補助起停〜複合シナリオ／運用コンソール／目的別4操作／post-policy・最小 UI・gateway／Ansible） | [KB-365-dgx-resource-phase3-workload-orchestration.md](./KB-365-dgx-resource-phase3-workload-orchestration.md) | 1件 | Phase3–6 に **Phase7**（**`main`**・**`956cccf7`** / **`0a136ce9`**・最小 UI・**`postPolicyStarts`**・実験 post-policy・**`experiment_lab_health_mode`**・**`api_dgx_resource_*`**）を追加 |
...
| [KB-365](./KB-365-dgx-resource-phase3-workload-orchestration.md) | DGXリソース Phase3–7（§Phase7 **`956cccf7` / `0a136ce9`・post-policy 複数・gateway ヘルス・inventory**／Phase6 **`5ac0f17d`**／Phase5 UI **`d449b655`**） | ✅ 記録（2026-05-03） |
