...
| キオスク統合ローン分析（計測機器 CSV+NFC） | [KB-344-unified-loan-analytics.md](./KB-344-unified-loan-analytics.md) | 1件 | 計測機器 `loan-analytics` API・NFCミラーイベント・5分重複統合（NFC優先）・取消除外・月次フィルタ・キオスク「集計」3タブ統一 |
