...
| キオスクIME・電源（調査中） | [KB-investigation-kiosk-ime-and-power-regression.md](./KB-investigation-kiosk-ime-and-power-regression.md) | 1件 | 備考欄の日本語入力モード切替・電源ボタンの同時不具合の実態調査（raspi4-robodrill01、clientKey不一致仮説） |
