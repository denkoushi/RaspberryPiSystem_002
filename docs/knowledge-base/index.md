...
- 2026-04-28（追記・順位ボード `leaderboard` 応答に機種名）: [KB-350](./KB-350-seiban-machine-name-supplement-fhinmei-mh-sh.md) — **`feat/kiosk-leaderboard-machine-name-enrich`**・**`e0305c8e`**・**Pi5 のみ**・Detach **`20260428-192136-21236`**・**Phase12 PASS 43/0/0**（約 **167s**）。**Pi3/Pi4 不要**（API のみ）。**PR**: （マージ後に番号を追記可）。
