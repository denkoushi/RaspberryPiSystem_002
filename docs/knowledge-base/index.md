...
| [KB-339](./KB-339-mobile-placement-barcode-survey.md) | 配膳スマホ V1/V2/V3 — 現場バーコードの意味確定・V2 照合/部品配膳（`OrderPlacementEvent`）・V3 棚番登録専用ページ | ✅ KB・API・Web・Runbook 整合（2026-04-11 本番 V3/V2・2026-04-10 V1・**AQUOS 実機は Runbook 手順で確認**） |
