...
| 吊具 持出・返却 可視化（キオスク API / `/kiosk/rigging-analytics`） | [KB-334-kiosk-rigging-loan-analytics-deploy.md](./KB-334-kiosk-rigging-loan-analytics-deploy.md) | 1件 | Pi5+キオスク Pi4×4 のみ順次デプロイ・`RASPI_SERVER_HOST`・Phase12・curl スモーク（2026-04-07） |
