...
| 写真持出 VLM ラベル | [KB-319-photo-loan-vlm-tool-label.md](./KB-319-photo-loan-vlm-tool-label.md) | 1件 | VLM 初版 + **フェーズ1（2026-03-29）**: 人レビュー列/API/管理 UI、Vision 入力（`PHOTO_TOOL_LABEL_VISION_*`・既定 `original`）、`resolvePhotoLoanToolDisplayLabel`、Pi5 実機（DB 列・401・Phase12 PASS 34/0/0）・TS |
