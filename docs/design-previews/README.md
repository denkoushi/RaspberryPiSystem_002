...
| [kiosk-inspection-drawing-edit-existing-sop.html](./kiosk-inspection-drawing-edit-existing-sop.html) | **生成済み・直接編集禁止** — 本番Reactルートから固定Playwrightで生成した検査図面取説。9シートで全操作を分割し、選択したカードだけを必須は橙実線、任意は控えめなスレート破線で対象へ接続する。`pnpm kiosk-sop:generate --all` で画像・HTML・manifestを同時更新する。**正本**: [ExecPlan](../plans/kiosk-sop-generated-maintenance-execplan.md) · [表示補正Plan](../plans/kiosk-sop-visual-layout-correction-execplan.md) · [ADR](../decisions/ADR-20260801-kiosk-sop-generated-from-production-ui.md) |
