...
| [kiosk-inspection-drawing-edit-existing-sop.html](./kiosk-inspection-drawing-edit-existing-sop.html) | **検査図面 既存編集 SOP（A4横・画面別ページ）** — 1枚目=一覧、2枚目=編集。左ステップレール＋右下隅番号。引出線はホバー時のみ。**正本**: [Plan](../plans/kiosk-inspection-drawing-edit-existing-sop.md) · [ADR](../decisions/ADR-20260728-inspection-drawing-sop-step-rail.md) |
