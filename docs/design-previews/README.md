...
| [kiosk-assembly-home-table-layout-preview.html](./kiosk-assembly-home-table-layout-preview.html) | **組立トップ（/kiosk/assembly）3ペイン** — Before=カード / After=検査図面ライブラリ同系のコンパクト表。登録済みロット・仕掛中・完了を高密度化。右のロット登録は現状維持。**実装反映済（Web）** · ブランチ `feat/kiosk-assembly-home-table-layout` · [Plan](../plans/kiosk-assembly-home-table-layout.md) · [ADR Decision 6](../decisions/ADR-20260707-assembly-kiosk-record-approval-and-ui-consistency.md) |
