...
| [kiosk-assembly-torque-input-operator-preview.html](./kiosk-assembly-torque-input-operator-preview.html) | **組立作業・トルク入力右ペイン（承認待ち）** — LEGACY入力待ち／NG再入力、REQUIRED確認前／agent待機／未接続・未受付を切替可能。丸数字は番号＋状態バッジ、履歴は直近3件を大きく表示。[ExecPlan](../plans/assembly-torque-wrench-traceability-execplan.md)・[提案ADR](../decisions/ADR-20260718-assembly-torque-input-operator-ui.md) |
