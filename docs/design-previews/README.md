...
| [kiosk-inspection-drawing-library-retire-and-keypad-preview.html](./kiosk-inspection-drawing-library-retire-and-keypad-preview.html) | **検査図面ライブラリ v2** — 上バーは**数字テンキーのみ**（入力欄・タイトル・説明なし・**nowrapで外寸維持**）・**数字部分一致**（7→71…）・行に**無効**・ボタン高さ **×0.7**。Before/After。**実装前・クリック可** |
