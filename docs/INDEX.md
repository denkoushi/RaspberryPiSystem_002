...
- **測定点名称ごとの寸法公差/幾何公差設定 + 上下限公差候補**: 初期ルールは「名称に `度` を含むなら幾何公差、それ以外は寸法公差」。管理コンソール `/admin/tools/part-measurement-templates` で名称ごとに上書きでき、キオスク検査図面の上限/下限公差入力に候補を出す。**正本**: [KB-320](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [Runbook](./runbooks/kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06)
...
- **検査図面 名称・公差種別設定（2026-07-06 · API+Web+migration）**: [KB-320 §名称・公差種別設定](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [Runbook](./runbooks/kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [verification](./guides/verification-checklist.md)
