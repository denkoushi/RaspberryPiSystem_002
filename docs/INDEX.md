...
- **RapidOCR 局所第2エンジン（実装中）**: 弱い候補のときだけ常駐 RapidOCR worker を追加。flag 既定 OFF。**正本**: [Plan](./plans/inspection-drawing-ocr-rapidocr-local.md) · [ADR-20260710](./decisions/ADR-20260710-inspection-drawing-ocr-rapidocr-local.md) · [KB-320](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-ocr-rapidocr局所-2026-07-10)
