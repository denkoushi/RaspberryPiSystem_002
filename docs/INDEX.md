...
- **測定点名称ごとの寸法公差/幾何公差設定 + 上下限公差候補**: 初期ルールは「名称に `度` を含むなら幾何公差、それ以外は寸法公差」。管理コンソール `/admin/tools/part-measurement-templates` で名称ごとに上書きでき、キオスク検査図面の上限/下限公差入力に候補を出す。**`20e90160`** · CI **`28758193791` success** · Deploy **`20260706-082903-1300`** · Phase12 **45/0/0**。**正本**: [KB-320](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [Runbook](./runbooks/kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [Deployment](./guides/deployment.md#inspection-drawing-tolerance-kind-settings-2026-07-06)
...
- **RapidOCR 局所第2エンジン**: 弱い候補のときだけ常駐 RapidOCR worker を追加。flag 既定 OFF。Pi5 のみ反映済 HEAD **`9811d39a`** · PR [#965](https://github.com/denkoushi/RaspberryPiSystem_002/pull/965)。**正本**: [Plan](./plans/inspection-drawing-ocr-rapidocr-local.md) · [ADR-20260710](./decisions/ADR-20260710-inspection-drawing-ocr-rapidocr-local.md) · [KB-320](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-ocr-rapidocr局所-2026-07-10) · [Deployment](./guides/deployment.md#inspection-drawing-ocr-rapidocr-local-2026-07-10)
...
- **検査図面 公差入力 実機フィードバック対応（2026-07-06 · Web/shared · Pi5+Pi4×5+Pi3本番OK · `becb6e7c`）**: [KB-320 §公差入力フィードバック](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-公差入力-実機フィードバック-2026-07-06) · [Runbook](./runbooks/kiosk-part-measurement.md#検査図面-公差入力-実機フィードバック-2026-07-06) · [Deployment](./guides/deployment.md#inspection-drawing-tolerance-input-usability-fixes-2026-07-06) · CI **`28760895857`** · Deploy **`20260706-100018-28681`** · Phase12 **45/0/0**
- **検査図面 名称・公差種別設定（2026-07-06 · API+Web+migration · Pi5+Pi4×5+Pi3本番OK · `20e90160`）**: [KB-320 §名称・公差種別設定](./knowledge-base/KB-320-kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [Runbook](./runbooks/kiosk-part-measurement.md#検査図面-名称-公差種別設定-2026-07-06) · [Deployment](./guides/deployment.md#inspection-drawing-tolerance-kind-settings-2026-07-06) · [verification](./guides/verification-checklist.md) · CI **`28758193791`** · Deploy **`20260706-082903-1300`** · Phase12 **45/0/0**
