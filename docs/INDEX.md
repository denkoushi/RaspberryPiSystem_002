...
- **Pi5 API成果物の有界runtime化**: API pull 1200秒・全体1500秒の有界運用を維持し、API専用依存・Ansible Core・headless shellでARM64 OCIを32.98%削減。単一SSD保存安全化は後続PR。**正本**: [ADR](./decisions/ADR-20260730-bounded-api-runtime-artifact.md) · [KB-404](./knowledge-base/KB-404-pi5-ghcr-api-image-pull-timeout.md) · [ExecPlan](./plans/pi5-api-image-local-storage-scalability-execplan.md)
