...
/** カード内の製番・品名・機種名・状態バッジを収める固定情報領域。 */
export const SELF_INSPECTION_MACHINE_BOARD_CARD_HEADER_HEIGHT = 96;
export const SELF_INSPECTION_MACHINE_BOARD_RESOURCE_ROW_HEIGHT = 40;
export const SELF_INSPECTION_MACHINE_BOARD_MIN_RESOURCE_ROW_HEIGHT = 36;
