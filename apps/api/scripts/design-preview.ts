...
function sampleMeasuringInstrumentLoanInspectionTable(): TableVisualizationData {
  return {
    kind: 'table',
    columns: ['従業員名', '貸出中計測機器数', '計測機器名称一覧', '計測機器明細'],
    rows: [
      {
        従業員名: '山田 太郎',
        点検件数: 2,
        貸出中計測機器数: 2,
        計測機器名称一覧: 'デジタルノギス (MI-001), マイクロメータ (MI-002)',
      ...
      { 従業員名: '佐藤 花子', 点検件数: 0, 貸出中計測機器数: 1, 計測機器名称一覧: 'トルクレンチ (MI-003)', 計測機器明細: '' },
      {
        従業員名: '高橋 一郎',
        点検件数: 1,
        貸出中計測機器数: 3,
      ...
      { 従業員名: '伊藤 晴美', 点検件数: 0, 貸出中計測機器数: 0, 計測機器名称一覧: '', 計測機器明細: '' },
      { 従業員名: '渡辺 直人', 点検件数: 1, 貸出中計測機器数: 1, 計測機器名称一覧: 'マイクロメータ (MI-007)', 計測機器明細: '' },
      {
        従業員名: '中村 美咲',
        点検件数: 0,
        貸出中計測機器数: 2,
      ...
      { 従業員名: '加藤 亜紀', 点検件数: 0, 貸出中計測機器数: 1, 計測機器名称一覧: 'テーパーゲージ (MI-014)', 計測機器明細: '' },
    ],
    metadata: {
