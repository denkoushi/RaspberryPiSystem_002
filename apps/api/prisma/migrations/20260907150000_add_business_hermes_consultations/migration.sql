...
ALTER TABLE "BusinessHermesConsultationMessage" ADD CONSTRAINT "BusinessHermesConsultationMessage_consultationId_fkey" FOREIGN KEY ("consultationId") REFERENCES "BusinessHermesConsultation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
