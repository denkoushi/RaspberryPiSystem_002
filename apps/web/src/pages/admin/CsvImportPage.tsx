...
const DEFAULT_COLUMN_DEFINITIONS: Record<CsvImportConfigType, CsvImportColumnDefinition[]> = {
  ...
  riggingGears: [
    { internalName: 'managementNumber', displayName: '管理番号', csvHeaderCandidates: ['managementNumber', '管理番号'], dataType: 'string', order: 0 },
    { internalName: 'name', displayName: '名称', csvHeaderCandidates: ['name', '名称'], dataType: 'string', order: 1 },
    { internalName: 'idNum', displayName: '旧番号', csvHeaderCandidates: ['idNum', 'ID_num', '旧番号'], dataType: 'string', order: 2, required: false },
    { internalName: 'storageLocation', displayName: '保管場所', csvHeaderCandidates: ['storageLocation', '保管場所'], dataType: 'string', order: 3, required: false },
    { internalName: 'department', displayName: '部署', csvHeaderCandidates: ['department', '部署'], dataType: 'string', order: 4, required: false },
    { internalName: 'startedAt', displayName: '使用開始日', csvHeaderCandidates: ['startedAt', '使用開始日'], dataType: 'date', order: 5, required: false },
    { internalName: 'usableYears', displayName: '使用年数', csvHeaderCandidates: ['usableYears', '使用年数'], dataType: 'number', order: 6, required: false },
    { internalName: 'maxLoadTon', displayName: '最大荷重(t)', csvHeaderCandidates: ['maxLoadTon', '最大荷重'], dataType: 'number', order: 7, required: false },
    { internalName: 'lengthMm', displayName: '長さ(mm)', csvHeaderCandidates: ['lengthMm', '長さ'], dataType: 'number', order: 8, required: false },
    { internalName: 'widthMm', displayName: '幅(mm)', csvHeaderCandidates: ['widthMm', '幅'], dataType: 'number', order: 9, required: false },
    { internalName: 'thicknessMm', displayName: '厚み(mm)', csvHeaderCandidates: ['thicknessMm', '厚み'], dataType: 'number', order: 10, required: false },
    { internalName: 'status', displayName: '状態', csvHeaderCandidates: ['status', '状態'], dataType: 'string', order: 11, required: false },
    { internalName: 'notes', displayName: '備考', csvHeaderCandidates: ['notes', '備考'], dataType: 'string', order: 12, required: false },
    { internalName: 'rfidTagUid', displayName: 'RFIDタグUID', csvHeaderCandidates: ['rfidTagUid', 'RFIDタグUID'], dataType: 'string', order: 13, required: false }
  ],
  machines: [
