...
export function WorkInstructionEditorInspector({
  ...
  return (
    <aside className="flex min-h-0 min-w-0 w-full flex-col gap-2 overflow-y-auto border-l border-white/10 bg-slate-900/75 p-3 text-sm xl:w-80 xl:shrink-0" aria-label="加工要領書オーバーレイ編集" aria-disabled={readOnly}>
      {memoReviewList}
