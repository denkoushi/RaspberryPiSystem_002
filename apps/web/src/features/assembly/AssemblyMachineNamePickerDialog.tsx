...
export function AssemblyMachineNamePickerDialog({
  isOpen,
  currentValue,
  disabled = false,
  onCancel,
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      void listAssemblyMachineNameCandidates({
        digitQuery,
        q: textQuery,
  ...
  return (
    <Dialog
      ...
      onClose={close}
      title="機種名を選択"
      description="数字テンキーを主に使い、必要な場合だけ文字条件を追加してください。両方の条件に一致する候補を表示します。"
      size="lg"
