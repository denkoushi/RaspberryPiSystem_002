  ...
  return (
    ...
    >
      {items.map((it) => (
        <div
          key={it.key}
          className="min-w-[12rem] shrink-0 rounded-xl border border-white/10 bg-slate-900/40 px-4 py-3 lg:min-w-0 lg:flex-1 lg:basis-0"
        >
          <div className="text-xs font-medium uppercase tracking-wide text-white/50">{it.label}</div>
