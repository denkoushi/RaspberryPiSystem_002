...
/** 沉浸式ヘッダー: 下辺中央1/3 のマウスホットゾーン（高さ 12px = h-3）。 */
export const KIOSK_IMMERSIVE_HEADER_HOT_ZONE_CLASS =
  'pointer-events-auto fixed bottom-0 left-1/3 z-40 h-3 w-1/3';
...
export const KIOSK_IMMERSIVE_HEADER_HIDDEN_TRANSFORM_CLASS = 'translate-y-full';
export const KIOSK_IMMERSIVE_HEADER_VISIBLE_TRANSFORM_CLASS = 'translate-y-0';
